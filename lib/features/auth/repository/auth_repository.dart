...
class AuthRepository {
  ...
  Future<GetUserModel> signInUser(
  ...
  Future<GetUserModel> addCompleteProfile(
  ...
  Future<Map<String, dynamic>> addApartment(
      {required String societyName,
      required String societyBlock,
  ...
  Future<Map<String, dynamic>> addGate(
      {required String societyName, required String gateAssign}) async {
    try {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      String? accessToken = prefs.getString('accessToken');
