                    ...
                    children: [
                      ...
                      Stack(
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                CircleAvatar(
                                  radius: 32,
                                  backgroundImage: widget.payload?.entryType ==
                                          'delivery'
                                      ? const AssetImage(
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: CircleAvatar(
                                        radius:
                                            40.0, // Increased size of the image
                                        backgroundImage: widget
                                                    .payload?.profileImg !=
                                                null
                                            ? NetworkImage(
                                                widget.payload!.profileImg!)
                                            : const AssetImage(
                                                'assets/images/profile.png'), // Asset image for profile
                                      ),
                                    ),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        if (widget.payload?.entryType !=
                                            'guest')
                                          Row(
                                            children: [
                                              CircleAvatar(
                                                radius: 16,
                                                backgroundImage: widget.payload
                                                                ?.entryType ==
                                                            'delivery' ||
                                                        widget.payload
                                                                ?.entryType ==
                                                    ...
                                                    ? AssetImage(widget
                                                        .payload!.companyLogo!)
                                                    : AssetImage(widget.payload
                                                            ?.serviceLogo ??
                                                        'assets/images/other/more_option.png'),
                          ...
                          Positioned(
                            bottom:
                                -60, // Adjusted for both button and text alignment
                            left: 50,
                            child: Row(
                      ...
                      Align(
                        ...
                        child: ClipOval(
                          child: Image.asset(
                            ...
                            width:
                                60, // Ensure the logo is displayed as a circle
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
