...
Future<void> showNotificationWithActions(payload) async {
  await AwesomeNotifications().createNotification(
    content: NotificationContent(
      ...
      customSound: "resource://raw/res_custom_sound",
      wakeUpScreen: true,
    ...
    actionButtons: [
      NotificationActionButton(
        key: 'APPROVE',
        label: 'Approve',
        autoDismissible: true, // Automatically dismisses the notification
        actionType: ActionType.SilentBackgroundAction, // Correct parameter name is actionType
...
Future<void> residentVerifyNotification(payload) async {
  await AwesomeNotifications().createNotification(
    content: NotificationContent(
      ...
      displayOnBackground: true,
      actionType: ActionType.Default,
      payload: payload, // Pass the string-converted payload
    ),
  );
}
